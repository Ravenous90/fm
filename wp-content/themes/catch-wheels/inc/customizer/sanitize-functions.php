<?php
/**
 * Catch Wheels Theme Options Sanitization Functions
 *
 ...
 */
function catch_wheels_sanitize_select( $input, $setting ) {
 ...
 */
function catch_wheels_sanitize_checkbox( $checked ) {
    // Boolean check.
 ...
 */
function catch_wheels_sanitize_post( $input ) {
 ...
 */
function catch_wheels_sanitize_image( $image, $setting ) {
    /*
 ...
 */
function catch_wheels_sanitize_category_list( $input ) {
    if ( '' != $input ) {
        if( in_array( 0, $input ) ) {
            return '0';
        }
 ...
 *                    the setting default.
 */
function catch_wheels_sanitize_number_range( $number, $setting ) {
